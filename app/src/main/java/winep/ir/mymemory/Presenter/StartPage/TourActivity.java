...
public class TourActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.tour_slide1,
                R.layout.tour_slide2,
                R.layout.tour_slide3,
                R.layout.tour_slide4
        };
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 4) {
                btnNext.setText(R.string.tour_page_agree);
                btnSkip.setText(R.string.tour_page_skip);
                btnSkip.setVisibility(View.VISIBLE);
            }
            if (position == layouts.length - 1) {
                // last page. make button text to GOT IT
                btnNext.setText(getString(R.string.tour_page_start));
